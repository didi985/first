...
<div>
  ...
  <div class="cxy_item">
    ...
    <div class="cxy_btn_s">
      <van-button color="#000" plain icon="https://img.yzcdn.cn/vant/user-active.png" size="small" type="info">
        按钮
      </van-button>
      <van-button color="#000" plain icon="https://img.yzcdn.cn/vant/user-active.png" size="small" type="info">
        按钮
  ...
  <van-popup v-model="show" position="right" :style="{ height: '100%',width:'100%' }">
    <div>
        <van-nav-bar title="错题记录" left-text="" left-arrow @click-left="onClickLeft" />
    </div>
  </van-popup>
</div>
</template>
