...
<div>
  ...
  <div class="cxy_item">
    ...
    <ul>
      <li>
        <input type="checkbox">
        <p>A、 <span>A．法拉第发现了电磁感应现象</span></p>
      </li>
            <li>
        <input type="checkbox">
        <p>A、 <span>A．法拉第发现了电磁感应现象</span></p>
    ...
    <div class="cxy_btn_t">
      <van-button color="#000" disabled  plain size="small">上一题</van-button>
      <van-button color="#000" plain size="small">确认</van-button>
      <van-button color="#000" plain size="small">下一题</van-button>
    </div>
    <div class="cxy_btn_s">
      <van-button color="#000" plain icon="https://img.yzcdn.cn/vant/user-active.png" size="small" type="info"  @click="Dialog()">
        移除错题
      </van-button>
      <van-button color="#000" plain icon="https://img.yzcdn.cn/vant/user-active.png" size="small" type="info" @click="daan">
        查看答案
      </van-button>
    </div>
  ...
  <!-- 查看答案小页面 --> 
  <el-card v-show="flag">
    <div class="cxy_da_top">
      <p>正确答案: <span>A</span></p>
      <p>你的答案: <span>C</span></p>
    </div>
    <div class="cxy_da_con">
      <p>考点</p>
      <ul>
        <li>物理</li>
        <li>物理学史</li>
  ...
  <van-popup v-model="show" position="right" :style="{ height: '100%',width:'100%' }">
    <div>
        <van-nav-bar title="答题卡" left-arrow @click-left="onClickLeft" />
    </div>
    <div class="cxy_cen"> 
            <div class="cxy_con">
        <div>物理学史</div>
    ...
    <footer>
      <van-button type="info" block  @click="Dialog()">结束巩固</van-button>
    </footer>
  </van-popup>

    <!-- 题目纠错右侧弹出层 -->
  <van-popup v-model="showTiMu" position="right" :style="{ height: '100%',width:'100%' }">
    <div>
        <van-nav-bar title="题目纠错反馈" left-arrow @click-left="onClickLeft" />
    </div>
   <div class="cxy_correct">
     <p>纠错类型</p>
     <div class="nei">
       <p><input type="radio" name="a"> 错别字</p>
       <p><input type="radio" name="a"> 答案解析不匹配</p>
       <p><input type="radio" name="a"> 解析错误</p>
       <p><input type="radio" name="a"> 其他</p>
     </div>
   </div>
   <el-card>
     <textarea name="" id="" cols="200" rows="10" placeholder="请输入题目纠错信息，最多不超过500个字"></textarea>
     <p>
     <button>提交</button>
     </p>
   </el-card>
